...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
  ...
  <div class="bg-gradient-to-tr from-blue-100 to-white p-5 rounded-2xl shadow-md border border-blue-200 flex items-center gap-4">
    ...
    <div>
      ...
      <h3 class="text-2xl font-bold text-blue-800">{{ $users }}</h3>
    </div>
  </div>
  ...
  <div class="bg-gradient-to-tr from-blue-100 to-white p-5 rounded-2xl shadow-md border border-blue-200 flex items-center gap-4">
    ...
    <div>
      ...
      <h3 class="text-2xl font-bold text-blue-800">{{ $pools }}</h3>
    </div>
  </div>
  ...
  <div class="bg-gradient-to-tr from-blue-100 to-white p-5 rounded-2xl shadow-md border border-blue-200 flex items-center gap-4">
    ...
    <div>
      ...
      <h3 class="text-2xl font-bold text-blue-800">{{ $bookings }}</h3>
    </div>
  </div>
  ...
  <div class="bg-gradient-to-tr from-blue-100 to-white p-5 rounded-2xl shadow-md border border-blue-200 flex items-center gap-4">
    ...
    <div>
      ...
      <h3 class="text-2xl font-bold text-blue-800">Rp 5.200.000</h3>
    </div>
  </div>
  --}}
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
      ...
      <ul class="space-y-2 text-sm text-gray-700">
        <li><i class="fas fa-hourglass-half text-yellow-500 mr-2"></i> Pending: <span class="font-semibold">{{ $pending }}</span></li>
        <li><i class="fas fa-spinner animate-spin text-blue-500 mr-2"></i> Proses: <span class="font-semibold">{{ $processing }}</span></li>
        <li><i class="fas fa-check-circle text-green-500 mr-2"></i> Selesai: <span class="font-semibold">{{ $completed }}</span></li>
      </ul>
    </div>
    <div>
