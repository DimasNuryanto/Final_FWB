...
<head>
  ...
  <title>Registrasi | SwimZone</title>
...
<body class="bg-blue-50 min-h-screen flex items-center justify-center px-4 py-8">
  ...
  <div class="w-full max-w-4xl bg-white shadow-2xl rounded-3xl overflow-hidden flex flex-col lg:flex-row">
    ...
    <div class="lg:w-2/3 w-full p-10 flex flex-col justify-center">
      <h3 class="text-2xl font-bold text-blue-800 mb-6 text-center lg:text-left">Buat Akun SwimZone</h3>
      ...
      <form action="<?php echo e(route('register.post')); ?>" method="POST" class="space-y-5">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laragon\www\reservasi\resources\views/register.blade.php ENDPATH**/ ?>